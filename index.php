        ...
        <div class="container p-0">
            <div class="row">
                ...
                <div class="col-8">
                    <div class="row">
                        <div class="col">
                            <a href="#"><i class="text-i fa fa-envelope" aria-hidden="true"></i>kirov-komi-srub@mail.ru</a>    
                        </div>
                        <div class="col">
                            <p class="phone-box text-right"><i class="text-i fa fa-phone-square" aria-hidden="true"></i>8 (919) 516-00-99<br>8 (963) 551-00-99</p>    
                        </div>
                        <div class="col">
                            <a href="#" role="button" class="btn btn-danger btn-block">Заказать звонок</a>    
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
    ...
    <section class="container-fluid about-us bg-w text-center">
        ...
        <div class="container">
            <div class="row mt-5">
                <div class="col">
                    <div class="card-dev">
                        <p class="card-dev-text">Имеем богатую базу материалов и собственное производство, поэтому можем предоставить любой пиломатериал для вас</p>
                        <h3>срубы ручной рубки</h3>
                    </div>
                </div> 
                <div class="col">
                    <div class="card-dev">
